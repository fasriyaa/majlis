  ...
  <div class="content-header">
    <div class="container-fluid">
      ...
      <div class="row mb-2">
        <div class="col-sm-1">
            @can('Create Members')
            <a href = "{{route('members.create')}}"><button type="button" class="btn btn-info">New Memeber</button></a>
            @endcan
        </div>
      </div>
    </div>
                        ...
                        <div class="btn-group">
                          ...
                          <button type="button" class="btn btn-info dropdown-toggle dropdown-icon" data-toggle="dropdown">
                            ...
                            <div class="dropdown-menu" role="menu">
                              @can('Edit Members')
                                <a class="dropdown-item" href="" onclick ="location.href='/members/'+{{$member->id}} +'/edit';">Edit</a>
                              @endcan
