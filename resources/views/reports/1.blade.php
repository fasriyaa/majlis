...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Payment Vouchers with Contract Category</h1>
          <p>ALL</p>
        </div>
              ...
              <table id = "contracts_table" class="table table-hover">
                <thead>
                    <tr align = "left">
                      ...
                      <th>Goods</th>
                      <th>Consultants' Services</th>
                      <th>Training</th>
                      <th>Non Consulting Services</th>
                      <th>Incremental Operating Costs</th>
                    </tr>
                </thead>
