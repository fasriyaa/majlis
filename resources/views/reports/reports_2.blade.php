...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      ...
      <!-- /.row -->
      <div class="row mb-2">
          {!! Form::open(['method' => 'POST', 'route' => ['_reports_2'], 'files' => false,]) !!}
            <div class="form-group row">
              <label class="col-sm-3 col-form-label">Select Date</label>
              <div class="col-sm-6">
                <input type = "text" id = "datepicker" name = "date" class = "form-control" value = "{{date("m/d/Y",strtotime($date ?? date("m/d/Y")))}}">
              </div>
              <div class="col-sm-2">
