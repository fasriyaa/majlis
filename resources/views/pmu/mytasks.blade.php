          ...
          @foreach($subtasks as $subtask)
                <tr>
                  ...
                  @foreach($tasks as $task)
                      ...
                      <td field-key='action'>
                        <a href="{{ route('pmu.toTaskTimeline',[$subtask->id]) }}" class="fa fa-eye"></a>
                ...
                @foreach($pending_approvals as $pending_approval)
                  <tr>
                      ...
                      <td field-key='action'>
                        <a href="{{ route('pmu.toTaskTimeline',[$pending_approval->task_id]) }}" class="fa fa-eye"></a>
                ...
                <tr>
                    ...
                    <td field-key='action'>
                      <a href="{{ route('pmu.toTaskTimeline',[$pending_doc->id]) }}" class="fa fa-eye"></a>
            ...
            <div class="card-body table-responsive p-0">
              <table class="table table-hover">
                ...
                <tr>
                    ...
                    <td field-key='action'>
                      <a href="{{ route('pmu.toTaskTimeline',[$assigned_task->id]) }}" class="fa fa-eye"></a>
