                  ...
                  <div class="col-md-6">
                    ...
                    <div class="card card-info">
                      <div class="card-header">
                        <h3 class="card-title">New sub item</h3>
                      </div>
                      <!-- /.card-header -->
                      <!-- form start -->
                      {!! Form::open(['method' => 'POST', 'route' => ['subitem.store'], 'files' => false,]) !!}
                        <div class="card-body">
                          ...
                          <div class="form-group">
                            ...
                            {!! Form::text('name', old('name'), ['class' => 'form-control', 'placeholder' => 'Enter Module Name']) !!}
                          </div>

                          <div class="form-group">
                            <label for="name">Start Date</label>
                            <!-- <input type="text" class="form-control" id="name" placeholder="Enter email"> -->
                            {!! Form::text('start_date', old('start_date'), ['id' => 'datepicker','class' => 'form-control', 'placeholder' => 'mm/dd/yyyy']) !!}
